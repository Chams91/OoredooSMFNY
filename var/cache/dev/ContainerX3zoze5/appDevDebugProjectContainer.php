...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'fr3d_ldap.ldap_driver.zend' => 'getFr3dLdap_LdapDriver_ZendService.php',
            'fr3d_ldap.ldap_manager.default' => 'getFr3dLdap_LdapManager_DefaultService.php',
            'fr3d_ldap.security.authentication.provider' => 'getFr3dLdap_Security_Authentication_ProviderService.php',
            'fr3d_ldap.security.authentication.provider.main' => 'getFr3dLdap_Security_Authentication_Provider_MainService.php',
            'fr3d_ldap.security.user.provider' => 'getFr3dLdap_Security_User_ProviderService.php',
            'fr3d_ldap.user_hydrator.default' => 'getFr3dLdap_UserHydrator_DefaultService.php',
            'fr3d_ldap.validator.unique' => 'getFr3dLdap_Validator_UniqueService.php',
            ...
            'monolog.logger.ldap_driver' => 'getMonolog_Logger_LdapDriverService.php',
        ...
        $this->privates = array(
            ...
            'fr3d_ldap.ldap_driver' => true,
            'fr3d_ldap.ldap_manager' => true,
            'fr3d_ldap.user_hydrator' => true,
            ...
            'fr3d_ldap.ldap_driver.zend' => true,
            'fr3d_ldap.ldap_manager.default' => true,
            'fr3d_ldap.security.authentication.provider' => true,
            'fr3d_ldap.security.authentication.provider.main' => true,
            'fr3d_ldap.security.user.provider' => true,
            'fr3d_ldap.user_hydrator.default' => true,
            'fr3d_ldap.validator.unique' => true,
            ...
            'monolog.logger.ldap_driver' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('gL-yUVhDDN', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L0CdcaB-7x', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EiAtqbe6D3', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3jkgqlWmR5', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U6ZFhbeiZ5', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['fr3d_ldap.security.authentication.provider.main']) ? $this->services['fr3d_ldap.security.authentication.provider.main'] : $this->load('getFr3dLdap_Security_Authentication_Provider_MainService.php')) && false ?: '_'};
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('FR3D\\LdapBundle\\Validator\\UniqueValidator' => function () {
            return ${($_ = isset($this->services['fr3d_ldap.validator.unique']) ? $this->services['fr3d_ldap.validator.unique'] : $this->load('getFr3dLdap_Validator_UniqueService.php')) && false ?: '_'};
            ...
            return ${($_ = isset($this->services['doctrine.orm.validator.unique']) ? $this->services['doctrine.orm.validator.unique'] : $this->load('getDoctrine_Orm_Validator_UniqueService.php')) && false ?: '_'};
        }, 'fr3d_ldap.validator.unique' => function () {
            return ${($_ = isset($this->services['fr3d_ldap.validator.unique']) ? $this->services['fr3d_ldap.validator.unique'] : $this->load('getFr3dLdap_Validator_UniqueService.php')) && false ?: '_'};
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'pidevxproyecto@gmail.com' => 'chams_mansouri',
            ),
